<x-app-layout>
    ...
    <div class="bg-gray-800 rounded-lg shadow p-6 text-white max-w-xl mx-auto mt-6">
        ...
        <form action="{{ route('assigned-items.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">Assign</button>
            </div>
        </form>
    </div>
</x-app-layout>
